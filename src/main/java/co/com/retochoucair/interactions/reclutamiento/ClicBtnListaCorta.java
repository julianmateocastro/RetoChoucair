...
public class ClicBtnListaCorta implements Interaction {
    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                Click.on(BOTON_LISTA_CORTA));
        ;
    }

    public static ClicBtnListaCorta clic(){
        return Tasks.instrumented(ClicBtnListaCorta.class);
    }
}
